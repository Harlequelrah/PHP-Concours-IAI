...
$select=$mybase->prepare("SELECT id_candidat,nom,prenom from candidats WHERE document_naissance IS NULL OR document_nationalite IS NULL OR document_attestation_bac IS NULL");
$select->execute();
$select_key=['id_candidat','nom','prenom'];
